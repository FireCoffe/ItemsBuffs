...
namespace ItemsBuffs.Projectiles
{
	public class VampProj : ModProjectile //before tweak update v.1.2 this projectile heal only 4-7 heals per second , now this projectile heal 4-7 every shot 
	{
		...
		{
			DisplayName.SetDefault("Vampire Projectile unnerfed"); //name of projectile
		}
        ...
        public override void OnHitNPC(NPC n, int damage, float knockback, bool crit)
        {
            ...
            int healamnt = (int)(projectile.damage * .300); //200 heal 7per second 120 4 per second 150 5 per second  3 100 per second. the issue may be by the amount of healing or idk
